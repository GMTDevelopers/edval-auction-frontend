    ...
    return ( 
        <div className={styles.sideCardCont}>
            ...
            <div className={styles.right}>
                ...
                <p onClick={()=> openModal(<AssignWinner id={lots.id} regBidders={bidders} activeLotData={activeLot} name={lots.artwork.title} artist={lots.artwork.artist_details.first_name} year={lots.artwork.year_created} thumb={lots?.artwork?.images[1]?.url} />)}  style={{color:"#FB6900", fontWeight:600}}>
